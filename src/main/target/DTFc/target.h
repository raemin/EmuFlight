...
#define TARGET_BOARD_IDENTIFIER "DTFc"
...
// -- modif Raoul  (pas ce type de gyro sur la DTFc/DOGE)
...
// -- modif Raoul  (pas de barometre sur DTFc/DOGE)
//define USE_BARO
...
// ------------------------------------------------------
// -- Modification RAOUL pour réduire l empreinte mémoire
// ------------------------------------------------------
...
// USE_SERIALRX_SBUS         // Frsky and Futaba receivers
// USE_SERIALRX_SPEKTRUM     // SRXL, DSM2 and DSMX protocol
...
// USE_BRUSHED_ESC_AUTODETECT         // impossible de le retirer compte tenu des dépendances
